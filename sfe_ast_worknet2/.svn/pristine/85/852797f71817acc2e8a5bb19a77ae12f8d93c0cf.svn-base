...
function calendar_set(e) {
    ...
    calendar_div.style.cssText = "z-index:1000; width:160px; padding:10px; border-top: 2px solid #1BA200; border-bottom: 1px solid lightGray; background-color:#ffffff;";
    calendar_div.style.position = "absolute";
    calendar_div.style.top = pos_y + 3 + 'px';
...
function calendar_draw(set_date) {
    ...
    html += "<a style=\"cursor:pointer;\" onClick=\"calendar_draw('" + prev_y + "')\"><</a>&nbsp;&nbsp;";
    html += "<a style=\"cursor:pointer;\" onClick=\"calendar_years_toggle()\">" + calendar_y + "년</a>&nbsp;&nbsp;";
    html += "<a style=\"cursor:pointer;\" onClick=\"calendar_draw('" + next_y + "')\">></a>&nbsp;&nbsp;&nbsp;";
    html += "<a style=\"cursor:pointer;\" onClick=\"calendar_draw('" + prev_m + "')\"><</a>&nbsp;&nbsp;";
    html += "<a style=\"cursor:pointer;\" onClick=\"calendar_months_toggle()\">" + calendar_m + "월</a>&nbsp;&nbsp;";
    html += "<a style=\"cursor:pointer;\" onClick=\"calendar_draw('" + next_m + "')\">></a>&nbsp;&nbsp;";
    html += "</div>";
    html += "<div style=\"float:right\">";
    html += "<span style=\"cursor:pointer; font-weight:bold;\" onClick=\"calendar_close()\">X</span>";
    html += "</div>";
    html += "</div>";
    html += "</td>";
    html += "</tr>";
    // 요일표시 html
    html += "<tr height=\"20\">";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">일</td>";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">월</td>";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">화</td>";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">수</td>";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">목</td>";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">금</td>";
    html += "<td style=\"background-color:#E0FED8; text-align:center; font-weight:bold; font-size:11px;\">토</td>";
    html += "</tr>";
...
function calendar_set_date(set_date) {
    ...
    if (calendar_obj) {
        ...
        // 추가 작업 함수 호출
        var func = calendar_obj.getAttribute('setDateAfter');
        if (func != undefined &&
            func != null) {
            resultText = calendar_obj.value;
            eval(func);
        }
    }
    calendar_close();
