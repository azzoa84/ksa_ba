...
(function ($)
{
    ...
    MultipleSelect.prototype =
    {
        ...
        init: function ()
        {
            ...
            {
            	this.options.selectAllChecked = true;
                $ul.append([
        ...
        events: function ()
        {
            ...
            this.$selectAll.off('click').on('click', function ()
            {
                ...
                that.options.selectAllChecked = checked;
        ...
        update: function (isInit)
        {
            ...
            this.$drop.find('input:checked').each(function () { $(this).parents('li').first().addClass('selected'); });
        ...
        updateSelectAll: function (isInit)
        {
            ...
            this.options.selectAllChecked = isInit ? isInit : false;
        ...
        getSelects: function (type)
        {
            ...
            if(type === 'text' && this.$selectGroups.length)
            {
                ...
                this.$selectGroups.each(function ()
                {
                    ...
                    {
                        var list = [];
                        $selected.each(function () { list.push($(this).parent().text()); });
                        html.push(': ' + list.join(', '));
                    }
                    html.push(']');
        ...
        setSelects: function (values)
        {
            ...
            this.options.selectAllChecked = this.$selectItems.length == this.$selectItems.filter(':checked').length + this.$disableItems.filter(':checked').length;
        ...
        getAllChecked : function() { return this.options.selectAllChecked; }
    };
    ...
    $.fn.multipleSelect.defaults =
    {
        ...
        allSelected: '전체선택',
        countSelected: '# of % 선택',
        noMatchesFound: '데이터없음',

        styler: function () { return false; },
        textTemplate: function ($elm) { return $elm.html(); },
        labelTemplate: function ($elm) { return $elm.attr('label'); },
